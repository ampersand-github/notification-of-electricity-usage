...
export class CustomerNumber extends AggregateRoot<ICustomerNumberDomain, CustomerNumberId> {
  public static create(props: ICustomerNumberDomain): CustomerNumber {
    return new CustomerNumber(props, CustomerNumberId.create());
  }

  public static restore(props: ICustomerNumberDomain, id: CustomerNumberId): CustomerNumber {
