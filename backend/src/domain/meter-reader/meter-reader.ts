...
export class MeterReader extends AggregateRoot<IMeterReaderDomain, MeterReaderId> {
  public static create (props: IMeterReaderDomain): MeterReader {
    return new MeterReader(props, MeterReaderId.create())
  }

  public static restore (props: IMeterReaderDomain, id: MeterReaderId): MeterReader {
